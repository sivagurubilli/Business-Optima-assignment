...
const ServicesByOutlet = () => {
  ...
  const getServices = async () => {
    setLoading(true);
    try {
      const response = await ServicesService.getservicesbyoutlet({outletId:id, page: currentPage,
        limit: itemsPerPage});
              ...
              <Tbody>
                {filteredData.map((outlet) => (
                  <Tr key={outlet._id} textAlign="center">
                    ...
                    <Td textAlign="center">{outlet?.duration}</Td>
                    <Td textAlign="center">{outlet?.price_info?.sale_price}</Td>
                    <Td textAlign="center">
...
export default ServicesByOutlet;
