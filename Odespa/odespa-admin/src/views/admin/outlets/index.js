...
const Outlets = () => {
  ...
  const getOutlets = async () => {
    ...
    try {
      ...
      if (response) {
        setOutlets(response.details); // Set outlet data to states
            ...
            <Table variant="striped" colorScheme="gray">
              <Thead bg="#F4F7FE">
                <Tr>
                  ...
                  <Th textAlign="center">Outlet Name</Th>
              ...
              <Tbody>
                {filteredData.map((outlet, index) => (
                  <Tr key={outlet._id} textAlign="center">
                    ...
                    <Td textAlign="center">{outlet?.address_info?.city}</Td>
                    <Td textAlign="center">
                      {outlet?.contact_info?.phone_1?.number}
                    </Td>
                    <Td textAlign="center">
                      <Flex justifyContent="center" gap={2}>
                        <Button
                          ...
                          colorScheme="teal"
                          onClick={() =>
                            navigate(`/admin/outlet/categories/${outlet._id}`)
                          }
                        >
                          Outlet Categories
                        </Button>
                        <Button
                          ...
                          colorScheme="teal"
                          onClick={() =>
                            navigate(`/admin/outlet/services/${outlet._id}`)
                          }
                        >
                          Outlet Services
                        </Button>
                        ...
                        <Button
                          ...
                          colorScheme="teal"
                          onClick={() =>
                            navigate(`/admin/outlet/${outlet._id}`)
                          }
                        >
                          View
                        </Button>
